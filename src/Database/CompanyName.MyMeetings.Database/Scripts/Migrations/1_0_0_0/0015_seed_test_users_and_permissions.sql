-- Test users, permission catalog, and role–permission links (see ../SeedDatabase.sql for manual use).
-- Applied by DatabaseMigrator after 0014; same content as a fresh Docker/compose DB seed.
